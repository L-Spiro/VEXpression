...
MISSING_IN_SIMDE = [
    ...
    # --- Targeted Mask Exclusions (Missing in SIMDe) ---
    "_mm256_mask_abs_epi16", "_mm256_maskz_abs_epi16",
    "_mm256_mask_abs_epi32", "_mm256_maskz_abs_epi32",
    "_mm256_mask_abs_epi8", "_mm256_maskz_abs_epi8",
    ...
    "_mm_mask_and_epi32", "_mm_maskz_and_epi32",
    "_mm256_mask_and_epi32", "_mm256_maskz_and_epi32",
    "_mm_mask_and_epi64", "_mm_maskz_and_epi64",
    "_mm256_mask_and_epi64", "_mm256_maskz_and_epi64",
    "_mm_mask_and_pd", "_mm_maskz_and_pd",
    "_mm256_mask_and_pd", "_mm256_maskz_and_pd",
    "_mm_mask_and_ps", "_mm_maskz_and_ps",
    "_mm256_mask_and_ps", "_mm256_maskz_and_ps",
    "_mm_mask_andnot_epi32", "_mm_maskz_andnot_epi32",
    "_mm256_mask_andnot_epi32", "_mm256_maskz_andnot_epi32",
    "_mm_mask_andnot_epi64", "_mm_maskz_andnot_epi64",
    "_mm256_mask_andnot_epi64", "_mm256_maskz_andnot_epi64",
    "_mm_mask_andnot_pd", "_mm_maskz_andnot_pd",
    "_mm256_mask_andnot_pd", "_mm256_maskz_andnot_pd",
    "_mm_mask_andnot_ps", "_mm_maskz_andnot_ps",
    "_mm256_mask_andnot_ps", "_mm256_maskz_andnot_ps",
    ...
    "_mm_mask_compress_epi32", "_mm_maskz_compress_epi32",
    "_mm_mask_compress_epi64", "_mm_maskz_compress_epi64",
    "_mm_mask_compress_epi8", "_mm_maskz_compress_epi8",
    "_mm256_mask_compress_epi8", "_mm256_maskz_compress_epi8",
    "_mm512_mask_compress_epi8", "_mm512_maskz_compress_epi8",
    "_mm_mask_compress_pd", "_mm_maskz_compress_pd",
    "_mm_mask_compress_ps", "_mm_maskz_compress_ps",
    "_mm_mask_cvtepi32_ps", "_mm_maskz_cvtepi32_ps",
    "_mm256_mask_cvtepi32_ps", "_mm256_maskz_cvtepi32_ps",
    "_mm512_mask_cvtepi32_ps", "_mm512_maskz_cvtepi32_ps",
    "_mm512_mask_cvtepu32_ps", "_mm512_maskz_cvtepu32_ps",
    "_mm_mask_cvtph_ps", "_mm_maskz_cvtph_ps",
    "_mm256_mask_cvtph_ps", "_mm256_maskz_cvtph_ps",
    "_mm512_mask_cvtph_ps", "_mm512_maskz_cvtph_ps",
    "_mm_mask_cvtsd_ss", "_mm_maskz_cvtsd_ss",
    "_mm_mask_cvtss_sd", "_mm_maskz_cvtss_sd",
    ...
    "_mm_mask_expand_epi16", "_mm_maskz_expand_epi16",
    "_mm256_mask_expand_epi16", "_mm256_maskz_expand_epi16",
    "_mm512_mask_expand_epi16", "_mm512_maskz_expand_epi16",
    "_mm_mask_expand_epi32", "_mm_maskz_expand_epi32",
    "_mm512_mask_expand_epi32", "_mm512_maskz_expand_epi32",
    "_mm_mask_expand_epi64", "_mm_maskz_expand_epi64",
    "_mm256_mask_expand_epi64", "_mm256_maskz_expand_epi64",
    "_mm512_mask_expand_epi64", "_mm512_maskz_expand_epi64",
    "_mm_mask_expand_epi8", "_mm_maskz_expand_epi8",
    "_mm256_mask_expand_epi8", "_mm256_maskz_expand_epi8",
    "_mm512_mask_expand_epi8", "_mm512_maskz_expand_epi8",
    "_mm_mask_expand_pd", "_mm_maskz_expand_pd",
    "_mm256_mask_expand_pd", "_mm256_maskz_expand_pd",
    "_mm512_mask_expand_pd", "_mm512_maskz_expand_pd",
    "_mm_mask_expand_ps", "_mm_maskz_expand_ps",
    "_mm256_mask_expand_ps", "_mm256_maskz_expand_ps",
    "_mm512_mask_expand_ps", "_mm512_maskz_expand_ps",
    "_mm_mask_fmadd_pd", "_mm_mask3_fmadd_pd", "_mm_maskz_fmadd_pd",
    "_mm256_mask_fmadd_pd", "_mm256_mask3_fmadd_pd", "_mm256_maskz_fmadd_pd",
    "_mm512_mask_fmadd_pd", "_mm512_mask3_fmadd_pd", "_mm512_maskz_fmadd_pd",
    "_mm_mask_fmadd_ps", "_mm_mask3_fmadd_ps", "_mm_maskz_fmadd_ps",
    "_mm256_mask_fmadd_ps", "_mm256_mask3_fmadd_ps", "_mm256_maskz_fmadd_ps",
    "_mm512_mask_fmadd_ps", "_mm512_mask3_fmadd_ps", "_mm512_maskz_fmadd_ps",
    "_mm_mask_fmadd_sd", "_mm_mask3_fmadd_sd", "_mm_maskz_fmadd_sd",
    "_mm_mask_fmadd_ss", "_mm_mask3_fmadd_ss", "_mm_maskz_fmadd_ss",
    "_mm_mask_fmsub_pd", "_mm_mask3_fmsub_pd", "_mm_maskz_fmsub_pd",
    "_mm256_mask_fmsub_pd", "_mm256_mask3_fmsub_pd", "_mm256_maskz_fmsub_pd",
    "_mm512_mask_fmsub_pd", "_mm512_mask3_fmsub_pd", "_mm512_maskz_fmsub_pd",
    "_mm_mask_fmsub_ps", "_mm_mask3_fmsub_ps", "_mm_maskz_fmsub_ps",
    "_mm256_mask_fmsub_ps", "_mm256_mask3_fmsub_ps", "_mm256_maskz_fmsub_ps",
    "_mm512_mask_fmsub_ps", "_mm512_mask3_fmsub_ps", "_mm512_maskz_fmsub_ps",
    "_mm_mask_fmsub_sd", "_mm_mask3_fmsub_sd", "_mm_maskz_fmsub_sd",
    "_mm_mask_fmsub_ss", "_mm_mask3_fmsub_ss", "_mm_maskz_fmsub_ss",
    ...
    "_mm512_mask_fnmadd_ps", "_mm512_mask3_fnmadd_ps", "_mm512_maskz_fnmadd_ps",
    "_mm_mask_fnmadd_sd", "_mm_mask3_fnmadd_sd", "_mm_maskz_fnmadd_sd",
    "_mm_mask_fnmadd_ss", "_mm_mask3_fnmadd_ss", "_mm_maskz_fnmadd_ss",
    ...
    "_mm512_mask_fnmsub_pd", "_mm512_mask3_fnmsub_pd", "_mm512_maskz_fnmsub_pd",
    ...
    "_mm512_mask_fnmsub_ps", "_mm512_mask3_fnmsub_ps", "_mm512_maskz_fnmsub_ps",
    "_mm_mask_fnmsub_sd", "_mm_mask3_fnmsub_sd", "_mm_maskz_fnmsub_sd",
    "_mm_mask_fnmsub_ss", "_mm_mask3_fnmsub_ss", "_mm_maskz_fnmsub_ss",
    ...
    "_mm_mask_max_sd", "_mm_maskz_max_sd",
    "_mm_mask_max_ss", "_mm_maskz_max_ss",
    ...
    "_mm_mask_min_sd", "_mm_maskz_min_sd",
    "_mm_mask_min_ss", "_mm_maskz_min_ss",
    "_mm_mask_move_sd", "_mm_maskz_move_sd",
    "_mm_mask_move_ss", "_mm_maskz_move_ss",
    "_mm_mask_mul_epi32", "_mm_maskz_mul_epi32",
    "_mm256_mask_mul_epi32", "_mm256_maskz_mul_epi32",
    "_mm_mask_mul_epu32", "_mm_maskz_mul_epu32",
    "_mm256_mask_mul_epu32", "_mm256_maskz_mul_epu32",
    ...
    "_mm_mask_mulhi_epi16", "_mm_maskz_mulhi_epi16",
    "_mm256_mask_mulhi_epi16", "_mm256_maskz_mulhi_epi16",
    "_mm512_mask_mulhi_epi16", "_mm512_maskz_mulhi_epi16",
    "_mm_mask_mulhrs_epi16", "_mm_maskz_mulhrs_epi16",
    "_mm256_mask_mulhrs_epi16", "_mm256_maskz_mulhrs_epi16",
    "_mm512_mask_mulhrs_epi16", "_mm512_maskz_mulhrs_epi16",
    ...
    "_mm_mask_or_pd", "_mm_maskz_or_pd",
    "_mm256_mask_or_pd", "_mm256_maskz_or_pd",
    "_mm_mask_or_ps", "_mm_maskz_or_ps",
    "_mm256_mask_or_ps", "_mm256_maskz_or_ps",
    ...
    "_mm_mask_shuffle_epi8", "_mm_maskz_shuffle_epi8",
    "_mm256_mask_shuffle_epi8", "_mm256_maskz_shuffle_epi8",
    "_mm_mask_sll_epi16", "_mm_maskz_sll_epi16",
    "_mm256_mask_sll_epi16", "_mm256_maskz_sll_epi16",
    "_mm_mask_sll_epi32", "_mm_maskz_sll_epi32",
    "_mm256_mask_sll_epi32", "_mm256_maskz_sll_epi32",
    "_mm_mask_sll_epi64", "_mm_maskz_sll_epi64",
    "_mm256_mask_sll_epi64", "_mm256_maskz_sll_epi64",
    "_mm_mask_sllv_epi32", "_mm_maskz_sllv_epi32",
    "_mm256_mask_sllv_epi32", "_mm256_maskz_sllv_epi32",
    "_mm512_mask_sllv_epi32", "_mm512_maskz_sllv_epi32",
    "_mm_mask_sllv_epi64", "_mm_maskz_sllv_epi64",
    "_mm256_mask_sllv_epi64", "_mm256_maskz_sllv_epi64",
    "_mm512_mask_sllv_epi64", "_mm512_maskz_sllv_epi64",
    "_mm_mask_sqrt_pd", "_mm_maskz_sqrt_pd",
    "_mm256_mask_sqrt_pd", "_mm256_maskz_sqrt_pd",
    "_mm512_maskz_sqrt_pd",
    "_mm_mask_sqrt_ps", "_mm_maskz_sqrt_ps",
    "_mm256_mask_sqrt_ps", "_mm256_maskz_sqrt_ps",
    "_mm512_maskz_sqrt_ps",
    "_mm_mask_sqrt_sd", "_mm_maskz_sqrt_sd",
    "_mm_mask_sqrt_ss", "_mm_maskz_sqrt_ss",
    "_mm_mask_sra_epi16", "_mm_maskz_sra_epi16",
    "_mm256_mask_sra_epi16", "_mm256_maskz_sra_epi16",
    "_mm512_mask_sra_epi16", "_mm512_maskz_sra_epi16",
    "_mm_mask_sra_epi32", "_mm_maskz_sra_epi32",
    "_mm256_mask_sra_epi32", "_mm256_maskz_sra_epi32",
    "_mm512_mask_sra_epi32", "_mm512_maskz_sra_epi32",
    "_mm_mask_srl_epi16", "_mm_maskz_srl_epi16",
    "_mm256_mask_srl_epi16", "_mm256_maskz_srl_epi16",
    "_mm512_mask_srl_epi16", "_mm512_maskz_srl_epi16",
    "_mm_mask_srl_epi32", "_mm_maskz_srl_epi32",
    "_mm256_mask_srl_epi32", "_mm256_maskz_srl_epi32",
    "_mm_mask_srl_epi64", "_mm_maskz_srl_epi64",
    "_mm256_mask_srl_epi64", "_mm256_maskz_srl_epi64",
    "_mm256_mask_srlv_epi16", "_mm256_maskz_srlv_epi16",
    "_mm512_mask_srlv_epi16", "_mm512_maskz_srlv_epi16",
    "_mm256_mask_srlv_epi32", "_mm256_maskz_srlv_epi32",
    "_mm512_mask_srlv_epi32", "_mm512_maskz_srlv_epi32",
    "_mm256_mask_srlv_epi64", "_mm256_maskz_srlv_epi64",
    "_mm512_mask_srlv_epi64", "_mm512_maskz_srlv_epi64",
    ...
    "_mm_mask_xor_pd", "_mm_maskz_xor_pd",
    "_mm256_mask_xor_pd", "_mm256_maskz_xor_pd",
    "_mm_mask_xor_ps", "_mm_maskz_xor_ps",
    "_mm256_mask_xor_ps", "_mm256_maskz_xor_ps",
