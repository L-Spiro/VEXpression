#if !defined(SIMDE_MIPS_MSA_HADD_H)
#define SIMDE_MIPS_MSA_HADD_H
...
simde_v8i16
simde_msa_hadd_s_h(simde_v16i8 a, simde_v16i8 b) {
  #if defined(SIMDE_MIPS_MSA_NATIVE)
    return __msa_hadd_s_h(a, b);
  #else
    simde_v16i8_private
  ...
  #undef __msa_hadd_s_h
  #define __msa_hadd_s_h(a, b) simde_msa_hadd_s_h((a), (b))
#endif

SIMDE_FUNCTION_ATTRIBUTES
simde_v4i32
simde_msa_hadd_s_w(simde_v8i16 a, simde_v8i16 b) {
  #if defined(SIMDE_MIPS_MSA_NATIVE)
    return __msa_hadd_s_w(a, b);
  #else
    simde_v8i16_private
...
#if defined(SIMDE_MIPS_MSA_ENABLE_NATIVE_ALIASES)
  #undef __msa_hadd_s_w
  #define __msa_hadd_s_w(a, b) simde_msa_hadd_s_w((a), (b))
#endif

SIMDE_FUNCTION_ATTRIBUTES
simde_v2i64
simde_msa_hadd_s_d(simde_v4i32 a, simde_v4i32 b) {
  #if defined(SIMDE_MIPS_MSA_NATIVE)
    return __msa_hadd_s_d(a, b);
  #else
    simde_v4i32_private
...
#if defined(SIMDE_MIPS_MSA_ENABLE_NATIVE_ALIASES)
  #undef __msa_hadd_s_d
  #define __msa_hadd_s_d(a, b) simde_msa_hadd_s_d((a), (b))
#endif

SIMDE_FUNCTION_ATTRIBUTES
simde_v8u16
simde_msa_hadd_u_h(simde_v16u8 a, simde_v16u8 b) {
  #if defined(SIMDE_MIPS_MSA_NATIVE)
    return __msa_hadd_u_h(a, b);
  #else
    simde_v16u8_private
...
#if defined(SIMDE_MIPS_MSA_ENABLE_NATIVE_ALIASES)
  #undef __msa_hadd_u_h
  #define __msa_hadd_u_h(a, b) simde_msa_hadd_u_h((a), (b))
#endif

SIMDE_FUNCTION_ATTRIBUTES
simde_v4u32
simde_msa_hadd_u_w(simde_v8u16 a, simde_v8u16 b) {
  #if defined(SIMDE_MIPS_MSA_NATIVE)
    return __msa_hadd_u_w(a, b);
  #else
    simde_v8u16_private
...
#if defined(SIMDE_MIPS_MSA_ENABLE_NATIVE_ALIASES)
  #undef __msa_hadd_u_w
  #define __msa_hadd_u_w(a, b) simde_msa_hadd_u_w((a), (b))
#endif

SIMDE_FUNCTION_ATTRIBUTES
simde_v2u64
simde_msa_hadd_u_d(simde_v4u32 a, simde_v4u32 b) {
  #if defined(SIMDE_MIPS_MSA_NATIVE)
    return __msa_hadd_u_d(a, b);
  #else
    simde_v4u32_private
...
#if defined(SIMDE_MIPS_MSA_ENABLE_NATIVE_ALIASES)
  #undef __msa_hadd_u_d
  #define __msa_hadd_u_d(a, b) simde_msa_hadd_u_d((a), (b))
#endif
