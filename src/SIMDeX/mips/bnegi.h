#if !defined(SIMDE_MIPS_MSA_BNEGI_H)
#define SIMDE_MIPS_MSA_BNEGI_H
...
SIMDE_BEGIN_DECLS_
  ...
  #define simde_msa_bnegi_b(a, imm) __msa_bnegi_b((a), (imm))
#else
  SIMDE_FUNCTION_ATTRIBUTES
  simde_v16u8
  simde_msa_bnegi_b(simde_v16u8 a, const int imm) {
    simde_v16u8_private
  ...
  #undef __msa_bnegi_b
  #define __msa_bnegi_b(a, imm) simde_msa_bnegi_b((a), (imm))
#endif

#if defined(SIMDE_MIPS_MSA_NATIVE)
  #define simde_msa_bnegi_h(a, imm) __msa_bnegi_h((a), (imm))
#else
  SIMDE_FUNCTION_ATTRIBUTES
  simde_v8u16
  simde_msa_bnegi_h(simde_v8u16 a, const int imm) {
    simde_v8u16_private
...
#if defined(SIMDE_MIPS_MSA_ENABLE_NATIVE_ALIASES)
  #undef __msa_bnegi_h
  #define __msa_bnegi_h(a, imm) simde_msa_bnegi_h((a), (imm))
#endif

#if defined(SIMDE_MIPS_MSA_NATIVE)
  #define simde_msa_bnegi_w(a, imm) __msa_bnegi_w((a), (imm))
#else
  SIMDE_FUNCTION_ATTRIBUTES
  simde_v4u32
  simde_msa_bnegi_w(simde_v4u32 a, const int imm) {
    simde_v4u32_private
...
#if defined(SIMDE_MIPS_MSA_ENABLE_NATIVE_ALIASES)
  #undef __msa_bnegi_w
  #define __msa_bnegi_w(a, imm) simde_msa_bnegi_w((a), (imm))
#endif

#if defined(SIMDE_MIPS_MSA_NATIVE)
  #define simde_msa_bnegi_d(a, imm) __msa_bnegi_d((a), (imm))
#else
  SIMDE_FUNCTION_ATTRIBUTES
  simde_v2u64
  simde_msa_bnegi_d(simde_v2u64 a, const int imm) {
    simde_v2u64_private
...
#if defined(SIMDE_MIPS_MSA_ENABLE_NATIVE_ALIASES)
  #undef __msa_bnegi_d
  #define __msa_bnegi_d(a, imm) simde_msa_bnegi_d((a), (imm))
#endif
