#if !defined(SIMDE_MIPS_MSA_FCLE_H)
#define SIMDE_MIPS_MSA_FCLE_H
...
simde_v4i32
simde_msa_fcle_w(simde_v4f32 a, simde_v4f32 b) {
  #if defined(SIMDE_MIPS_MSA_NATIVE)
    return __msa_fcle_w(a, b);
  ...
  #undef __msa_fcle_w
  #define __msa_fcle_w(a, b) simde_msa_fcle_w((a), (b))
#endif

SIMDE_FUNCTION_ATTRIBUTES
simde_v2i64
simde_msa_fcle_d(simde_v2f64 a, simde_v2f64 b) {
  #if defined(SIMDE_MIPS_MSA_NATIVE)
    return __msa_fcle_d(a, b);
...
#if defined(SIMDE_MIPS_MSA_ENABLE_NATIVE_ALIASES)
  #undef __msa_fcle_d
  #define __msa_fcle_d(a, b) simde_msa_fcle_d((a), (b))
#endif
