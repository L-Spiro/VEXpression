#if !defined(SIMDE_MIPS_MSA_BNEG_H)
#define SIMDE_MIPS_MSA_BNEG_H
...
simde_v16u8
simde_msa_bneg_b(simde_v16u8 a, simde_v16u8 b) {
  #if defined(SIMDE_MIPS_MSA_NATIVE)
    return __msa_bneg_b(a, b);
  #else
    simde_v16u8_private
  ...
  #undef __msa_bneg_b
  #define __msa_bneg_b(a, b) simde_msa_bneg_b((a), (b))
#endif

SIMDE_FUNCTION_ATTRIBUTES
simde_v8u16
simde_msa_bneg_h(simde_v8u16 a, simde_v8u16 b) {
  #if defined(SIMDE_MIPS_MSA_NATIVE)
    return __msa_bneg_h(a, b);
  #else
    simde_v8u16_private
...
#if defined(SIMDE_MIPS_MSA_ENABLE_NATIVE_ALIASES)
  #undef __msa_bneg_h
  #define __msa_bneg_h(a, b) simde_msa_bneg_h((a), (b))
#endif

SIMDE_FUNCTION_ATTRIBUTES
simde_v4u32
simde_msa_bneg_w(simde_v4u32 a, simde_v4u32 b) {
  #if defined(SIMDE_MIPS_MSA_NATIVE)
    return __msa_bneg_w(a, b);
  #else
    simde_v4u32_private
...
#if defined(SIMDE_MIPS_MSA_ENABLE_NATIVE_ALIASES)
  #undef __msa_bneg_w
  #define __msa_bneg_w(a, b) simde_msa_bneg_w((a), (b))
#endif

SIMDE_FUNCTION_ATTRIBUTES
simde_v2u64
simde_msa_bneg_d(simde_v2u64 a, simde_v2u64 b) {
  #if defined(SIMDE_MIPS_MSA_NATIVE)
    return __msa_bneg_d(a, b);
  #else
    simde_v2u64_private
...
#if defined(SIMDE_MIPS_MSA_ENABLE_NATIVE_ALIASES)
  #undef __msa_bneg_d
  #define __msa_bneg_d(a, b) simde_msa_bneg_d((a), (b))
#endif
