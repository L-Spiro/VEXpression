#if !defined(SIMDE_MIPS_MSA_FSLT_H)
#define SIMDE_MIPS_MSA_FSLT_H
...
simde_v4i32
simde_msa_fslt_w(simde_v4f32 a, simde_v4f32 b) {
  #if defined(SIMDE_MIPS_MSA_NATIVE)
    return __msa_fslt_w(a, b);
  ...
  #undef __msa_fslt_w
  #define __msa_fslt_w(a, b) simde_msa_fslt_w((a), (b))
#endif

SIMDE_FUNCTION_ATTRIBUTES
simde_v2i64
simde_msa_fslt_d(simde_v2f64 a, simde_v2f64 b) {
  #if defined(SIMDE_MIPS_MSA_NATIVE)
    return __msa_fslt_d(a, b);
...
#if defined(SIMDE_MIPS_MSA_ENABLE_NATIVE_ALIASES)
  #undef __msa_fslt_d
  #define __msa_fslt_d(a, b) simde_msa_fslt_d((a), (b))
#endif
