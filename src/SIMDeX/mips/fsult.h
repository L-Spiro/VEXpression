#if !defined(SIMDE_MIPS_MSA_FSULT_H)
#define SIMDE_MIPS_MSA_FSULT_H
...
simde_v4i32
simde_msa_fsult_w(simde_v4f32 a, simde_v4f32 b) {
  #if defined(SIMDE_MIPS_MSA_NATIVE)
    return __msa_fsult_w(a, b);
    ...
    simde_v4i32_private r_;
      ...
      r_.v128 = wasm_v128_not(wasm_f32x4_ge(a_.v128, b_.v128));
    #else
      SIMDE_VECTORIZE
  ...
  #undef __msa_fsult_w
  #define __msa_fsult_w(a, b) simde_msa_fsult_w((a), (b))
#endif

SIMDE_FUNCTION_ATTRIBUTES
simde_v2i64
simde_msa_fsult_d(simde_v2f64 a, simde_v2f64 b) {
  #if defined(SIMDE_MIPS_MSA_NATIVE)
    return __msa_fsult_d(a, b);
  #elif defined(SIMDE_ARM_NEON_A64V8_NATIVE)
    return vreinterpretq_s64_u32(vmvnq_u32(vreinterpretq_u32_u64(vcgeq_f64(a, b))));
  #else
    simde_v2f64_private
    ...
    #elif defined(SIMDE_WASM_SIMD128_NATIVE)
      r_.v128 = wasm_v128_not(wasm_f64x2_ge(a_.v128, b_.v128));
    #else
      SIMDE_VECTORIZE
      for (size_t i = 0 ; i < (sizeof(r_.values) / sizeof(r_.values[0])) ; i++) {
...
#if defined(SIMDE_MIPS_MSA_ENABLE_NATIVE_ALIASES)
  #undef __msa_fsult_d
  #define __msa_fsult_d(a, b) simde_msa_fsult_d((a), (b))
#endif
