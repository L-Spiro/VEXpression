#if !defined(SIMDE_MIPS_MSA_FCLT_H)
#define SIMDE_MIPS_MSA_FCLT_H
...
simde_v4i32
simde_msa_fclt_w(simde_v4f32 a, simde_v4f32 b) {
  #if defined(SIMDE_MIPS_MSA_NATIVE)
    return __msa_fclt_w(a, b);
  ...
  #undef __msa_fclt_w
  #define __msa_fclt_w(a, b) simde_msa_fclt_w((a), (b))
#endif

SIMDE_FUNCTION_ATTRIBUTES
simde_v2i64
simde_msa_fclt_d(simde_v2f64 a, simde_v2f64 b) {
  #if defined(SIMDE_MIPS_MSA_NATIVE)
    return __msa_fclt_d(a, b);
  #elif defined(SIMDE_ARM_NEON_A64V8_NATIVE)
    return vreinterpretq_s64_u64(vcltq_f64(a, b));
  #else
    simde_v2f64_private
...
#if defined(SIMDE_MIPS_MSA_ENABLE_NATIVE_ALIASES)
  #undef __msa_fclt_d
  #define __msa_fclt_d(a, b) simde_msa_fclt_d((a), (b))
#endif
