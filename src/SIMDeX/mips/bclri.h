#if !defined(SIMDE_MIPS_MSA_BCLRI_H)
#define SIMDE_MIPS_MSA_BCLRI_H
...
SIMDE_BEGIN_DECLS_
  ...
  #define simde_msa_bclri_b(a, imm) __msa_bclri_b((a), (imm))
#else
  SIMDE_FUNCTION_ATTRIBUTES
  simde_v16u8
  simde_msa_bclri_b(simde_v16u8 a, const int imm) {
    simde_v16u8_private
  ...
  #undef __msa_bclri_b
  #define __msa_bclri_b(a, imm) simde_msa_bclri_b((a), (imm))
#endif

#if defined(SIMDE_MIPS_MSA_NATIVE)
  #define simde_msa_bclri_h(a, imm) __msa_bclri_h((a), (imm))
#else
  SIMDE_FUNCTION_ATTRIBUTES
  simde_v8u16
  simde_msa_bclri_h(simde_v8u16 a, const int imm) {
    simde_v8u16_private
...
#if defined(SIMDE_MIPS_MSA_ENABLE_NATIVE_ALIASES)
  #undef __msa_bclri_h
  #define __msa_bclri_h(a, imm) simde_msa_bclri_h((a), (imm))
#endif

#if defined(SIMDE_MIPS_MSA_NATIVE)
  #define simde_msa_bclri_w(a, imm) __msa_bclri_w((a), (imm))
#else
  SIMDE_FUNCTION_ATTRIBUTES
  simde_v4u32
  simde_msa_bclri_w(simde_v4u32 a, const int imm) {
    simde_v4u32_private
...
#if defined(SIMDE_MIPS_MSA_ENABLE_NATIVE_ALIASES)
  #undef __msa_bclri_w
  #define __msa_bclri_w(a, imm) simde_msa_bclri_w((a), (imm))
#endif

#if defined(SIMDE_MIPS_MSA_NATIVE)
  #define simde_msa_bclri_d(a, imm) __msa_bclri_d((a), (imm))
#else
  SIMDE_FUNCTION_ATTRIBUTES
  simde_v2u64
  simde_msa_bclri_d(simde_v2u64 a, const int imm) {
    simde_v2u64_private
...
#if defined(SIMDE_MIPS_MSA_ENABLE_NATIVE_ALIASES)
  #undef __msa_bclri_d
  #define __msa_bclri_d(a, imm) simde_msa_bclri_d((a), (imm))
#endif
