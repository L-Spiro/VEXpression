...
namespace ve {
	...
	/**
	 * Represents a compound bitwise XOR assignment operation (^=).
	 **/
	class BitXorAssignNode : public AstNode {
	public :
		BitXorAssignNode(size_t var, size_t right) : varIndex(var), rightIndex(right) {}


		// == Functions.
		/**
		 * Evaluates the compound bitwise XOR assignment of the variable and right child node.
		 * 
		 ...
		 **/
		virtual NodeType			type() const { return NodeType::BitXorAssign; }
