...
namespace ve {
	...
	/**
	 * Represents a logical AND operation between two child nodes.
	 **/
	class LogAndNode : public AstNode {
	public :
		LogAndNode(size_t left, size_t right) : leftIndex(left), rightIndex(right) {}

		
		// == Functions.
		/**
		 * Evaluates the logical AND of the left and right child nodes, providing short-circuit evaluation.
		 * 
		 ...
		 **/
		virtual NodeType			type() const { return NodeType::LogAnd; }
