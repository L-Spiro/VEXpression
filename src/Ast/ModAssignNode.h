...
namespace ve {
	...
	/**
	 * Represents a compound modulo assignment operation (%=).
	 **/
	class ModAssignNode : public AstNode {
	public :
		ModAssignNode(size_t var, size_t right) : varIndex(var), rightIndex(right) {}


		// == Functions.
		/**
		 * Evaluates the compound modulo assignment of the variable and right child node.
		 * 
